...
export default async function VideosPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 relative">
      ...
      <div className="hidden 2xl:block absolute top-10rem left-1rem w-60 h-60 md:w-80 md:h-80 pointer-events-none select-none opacity-90 hover:opacity-100 transition-opacity duration-300 z-10" style={{ position: 'fixed', top: '10rem', left: '1rem' }}>
        <Image
